    ...
    <div class="container-fluid col-xxl-8">
        <div class="row flex-lg-nowrap align-items-center g-5">
            <div class="order-lg-1 w-100">
                <img style="clip-path: polygon(25% 0%, 100% 0%, 100% 99%, 0% 100%);" src="{{asset('frontend/assets/images/hero-image.jpg')}}" class="d-block mx-lg-auto img-fluid" alt="unitopLogo" loading="lazy">
            </div>
