...
@section('main')
    ...
    <!-- ======= About Us Section ======= -->
    <div class="d-flex container-fluid" lc-helper="background" style="height:50vh; background:url({{asset('frontend/assets/images/hero-img-2.jpg')}})  center / cover no-repeat;"></div>
